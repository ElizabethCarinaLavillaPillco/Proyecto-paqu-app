...
public class perfilActivity extends BaseActivity {
    ...
    private void cargarRolUsuario() {
        // Obtener de SharedPreferences (guardado en login)
        SharedPreferences prefs = getSharedPreferences("AppPrefs", MODE_PRIVATE);
        String rol = prefs.getString("user_role", "usuario_comun");

        // Configurar según el rol
        switch (rol) {
            case "administrador":
                tvRol.setText("👑 ADMIN");
                tvRol.setBackgroundResource(R.drawable.bg_rol_admin);
                break;

            case "docente":
                tvRol.setText("📚 DOCENTE");
                tvRol.setBackgroundResource(R.drawable.bg_rol_docente);
                break;

            case "usuario_comun":
            default:
                tvRol.setText("👤 USUARIO");
                tvRol.setBackgroundResource(R.drawable.bg_rol_usuario);
                break;
        }
    }
