...
public class ejercicio6_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicio6_1);
        ...
        audioPlayer = MediaPlayer.create(this, R.raw.voz_oveja);
        ...
        setupOption(opcion1, "Waka", R.raw.voz_vaca);
        setupOption(opcion2, "Cabra", R.raw.voz_cabra);
        setupOption(opcion3, "Usha", R.raw.voz_oveja);
        setupOption(opcion4, "Atuq", R.raw.voz_zorro);
