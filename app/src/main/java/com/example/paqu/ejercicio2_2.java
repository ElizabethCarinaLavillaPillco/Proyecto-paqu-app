...
public class ejercicio2_2 extends AppCompatActivity {
    ...
    String oracionCorrecta = "Walliqlla";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        audio = MediaPlayer.create(this, R.raw.voz_walliqlla);
                ...
                if (s.toString().trim().isEmpty()) {
                    ...
                    checkButton.setBackgroundTintList(
                            ColorStateList.valueOf(
                                    Color.parseColor("#D6C7EB")));

                    checkButton.setTextColor(
                            Color.parseColor("#A594BF"));
        ...
        checkButton.setOnClickListener(v -> {
            ...
            String respuestaUsuario =
                    oracionConstruida.getText().toString();

            if (normalize(respuestaUsuario)
                    .equals(normalize(oracionCorrecta))) {
