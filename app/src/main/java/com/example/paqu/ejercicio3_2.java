...
public class ejercicio3_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        audio = MediaPlayer.create(this, R.raw.voz_yaya);
        ...
        checkButton.setOnClickListener(v -> {
            ...
            if (normalize(respuestaUsuario)
                    .equals(normalize(respuestaCorrecta))) {

                audioManager.reproducirExito();

                int expGanada = 10;
                int expTotal = expAcumulada + expGanada;
