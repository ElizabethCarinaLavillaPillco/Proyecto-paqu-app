...
public class ejercicio5_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicio5_2);
        ...
        audio = MediaPlayer.create(this, R.raw.voz_negro);
        ...
        checkButton.setOnClickListener(v -> {
            ...
            if (normalize(respuestaUsuario)
                ...
                showDialog(
                        "✅ ¡Excelente!",
                        "Has completado la lección de colores 🎉",
                        expTotal,
                        tiempoTotal
                );
