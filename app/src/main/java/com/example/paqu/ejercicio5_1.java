...
public class ejercicio5_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicio5_1);
        ...
        audioPlayer = MediaPlayer.create(this, R.raw.voz_azul);
        ...
        setupOption(opcion1, "Anqas", R.raw.voz_azul);
        setupOption(opcion2, "Yana", R.raw.voz_negro);
        setupOption(opcion3, "Yuraq", R.raw.voz_blanco);
        setupOption(opcion4, "Puka", R.raw.voz_rojo);
