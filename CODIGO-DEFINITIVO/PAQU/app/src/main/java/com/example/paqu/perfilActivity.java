...
public class perfilActivity extends BaseActivity {
    ...
    private void aplicarFuentesAutomaticas() {
        ...
        aplicarFuente(R.id.tvUsuario, 20f);        // "Nombre usuario xdd"
        aplicarFuente(R.id.tvDescripcion, 14f);    // "@Usuario Se unió en de 20XX"

        // Sección de idioma
        aplicarFuente(R.id.textView19, 16f);       // "Idioma"

        // Seguidores y siguiendo
        aplicarFuente(R.id.textView20, 14f);       // "Siguiendo"
        aplicarFuente(R.id.tvSiguiendo, 14f);      // "0"
        aplicarFuente(R.id.textView21, 14f);       // "Seguidores"
        aplicarFuente(R.id.tvSeguidores, 14f);     // "0"

        // Estadísticas
        aplicarFuente(R.id.textView24, 20f);       // "Resumen"
        aplicarFuente(R.id.tvExp, 16f);            // "0" (EXP)
        aplicarFuente(R.id.textView28, 16f);       // "EXP Totales"
        aplicarFuente(R.id.tvPuntaje, 16f);        // "0" (Puntaje)
        aplicarFuente(R.id.textView27, 16f);       // "Puntaje en Quechua"
